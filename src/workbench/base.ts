...
export function baseWorkbench(
  ...
  const tokens: Record<string, string> = {
    ...
    "terminal.ansiBlue": `${palette.dimBlue}`,
    ...
    "terminal.ansiCyan": `${palette.dimAqua}`,
    "terminal.ansiGreen": `${palette.dimGreen}`,
    "terminal.ansiMagenta": `${palette.dimPurple}`,
    "terminal.ansiRed": `${palette.dimRed}`,
    "terminal.ansiWhite": `${palette.grey2}`,
    "terminal.ansiYellow": `${palette.dimYellow}`,
